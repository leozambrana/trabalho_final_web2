...
const HomeHeader = dynamic(() => import("@/src/components/HeaderLogin/page"), {
  ssr: false,
});
          ...
          <div className="grid grid-cols-3 gap-4 m-20">
            {filteredFeaturedData.map((featuredArticle) => (
              <div
                ...
                className="flex justify-center items-center flex-col gap-10 p-4 border border-gray-300"
              >
                ...
                <div className="flex items-center">
                  ...
                  <button onClick={() => handleLike(featuredArticle._id)}>
                    <FaHeart
                      className={
                        currentLikes.includes(featuredArticle._id)
                          ? "text-red-500"
                          : ""
                      }
                    />
                  ...
                  <span>
                    {featuredArticle.kb_liked_count
                      ? featuredArticle.kb_liked_count
                      : 0}
                  </span>
                </div>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <button onClick={() => handleLike(artigoCurtido._id)}>
                    <FaHeart
                      className={
                        currentLikes.includes(artigoCurtido._id)
                          ? "text-red-500"
                          : ""
                      }
                    />
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <button onClick={() => handleLike(artigo._id)}>
                    <FaHeart
                      className={
                        currentLikes.includes(artigo._id) ? "text-red-500" : ""
                      }
                    />
                  </button>
                  <span>
                    {artigo.kb_liked_count ? artigo.kb_liked_count : 0}
                  </span>
                </div>
              </div>
            ))}
